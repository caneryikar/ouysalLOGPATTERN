...
</script></con:config></con:testStep><con:properties/></con:testCase><con:properties><con:property><con:name>biId</con:name><con:value>4</con:value></con:property><con:property><con:name>userSpecId</con:name><con:value>5</con:value></con:property><con:property><con:name>soSpecId</con:name><con:value>4</con:value></con:property><con:property><con:name>extId</con:name><con:value>userExtId${#TestSuite#entityId}</con:value></con:property><con:property><con:name>soId</con:name><con:value>6</con:value></con:property><con:property><con:name>userId</con:name><con:value>8</con:value></con:property><con:property><con:name>entityId</con:name><con:value>4018</con:value></con:property></con:properties></con:testSuite><con:testSuite id="a9745d91-32a5-48f2-920d-8f60d13980e6" name="MoneyTransfer"><con:settings/><con:runType>SEQUENTIAL</con:runType><con:testCase id="b5a59934-acce-464e-ae58-54baf7d4f234" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Initialize Money Transfer Properties" searchProperties="true"><con:settings/><con:testStep type="groovy" name="setTestCasesRunnableStatus" id="bacfd741-7514-4039-bb2e-7e2ee348c84c"><con:settings/><con:config><script>def project = testRunner.testCase.testSuite.project;
...
testRunner.testCase.testSuite.setPropertyValue("entityId", entityId);</script></con:config></con:testStep><con:testStep type="restrequest" name="listExchangeRates" id="5815c2d8-a8e4-43d3-8218-bb5c8a8df3a9"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="listExchangeRates" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="listExchangeRates" id="6cb93f23-e380-4b02-bb72-8d08504e8217" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="9c57f609-66e3-4d2d-b8d0-b404480b1d30" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="getExchangeRates" id="22d3ef7c-e908-420f-a3bf-ea361e9d6387"><con:settings/><con:config><script>import net.sf.json.groovy.*;

getExchangeRates()

void getExchangeRates(){

	String fromCurrencyId = testRunner.testCase.testSuite.getPropertyValue("fromCurrencyId");
	String toCurrencyId = testRunner.testCase.testSuite.getPropertyValue("toCurrencyId");
	String mainCurrencyId = testRunner.testCase.testSuite.getPropertyValue("mainCurrencyId");
	
	rateFound = getExchangeRate(fromCurrencyId, toCurrencyId, "addExchangeRateFromCurrencyToCurrency");
	rateFound = getExchangeRate(fromCurrencyId, mainCurrencyId, "addExchangeRateFromCurrencyToMainCurrency");
	rateFound = getExchangeRate(toCurrencyId, fromCurrencyId, "addExchangeRateToCurrencyFromCurrency");
	rateFound = getExchangeRate(toCurrencyId, mainCurrencyId, "addExchangeRateToCurrencyMainCurrency");
	rateFound = getExchangeRate(mainCurrencyId, fromCurrencyId, "addExchangeRateMainCurrencyFromCurrency");
	rateFound = getExchangeRate(mainCurrencyId, toCurrencyId, "addExchangeRateMainCurrencyToCurrency");

}

def getExchangeRate(String fromCurrencyId, String toCurrencyId, String testStepName){
	...
	for (jsonItem in json) {
		...
		if(jsonItem.fromCurrency == fromCurrencyId){
			if(jsonItem.toCurrency == toCurrencyId){
	...
	testStep = testRunner.testCase.getTestStepByName(testStepName);
	if(rateFound == true){
...
def getJson(String response){
	...
	return json
}</script></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateFromCurrencyToCurrency" id="5a0794f0-ca7f-4c5f-9422-185fa8ba7039"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromUSDToEUR" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#fromCurrencyId}",
    "toCurrency": "${#TestSuite#toCurrencyId}",
    "rate": 0.9,
    "fromDate": "2016-12-23T07:26:28+0000",
    "toDate": "2018-12-25T07:26:28+0000",
    "type": "com.ericsson.bss.rm.erms.core.entity.dto.pm.ExchangeRateDTO"
  }</con:request><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="3a388197-f591-4aff-9fee-7705a633e7b9" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateFromCurrencyToMainCurrency" id="b4171331-1130-4ea0-8938-edd8595b336d"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromUSDToTL" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#fromCurrencyId}",
    "toCurrency": "${#TestSuite#mainCurrencyId}",
    "rate": 3.65,
    "fromDate": "2016-12-23T07:26:28+0000",
    "toDate": "2018-12-25T07:26:28+0000",
    "type": "com.ericsson.bss.rm.erms.core.entity.dto.pm.ExchangeRateDTO"
  }</con:request><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="4af62634-6991-4948-b87b-81ffce474dd4" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateToCurrencyFromCurrency" id="2e2621d1-1e2c-4f82-b391-7c59664f9b37"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromEURToUSD" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#toCurrencyId}",
    "toCurrency": "${#TestSuite#fromCurrencyId}",
    "rate": 1.15,
    "fromDate": "2016-12-23T07:26:28+0000",
    "toDate": "2018-12-25T07:26:28+0000",
    "type": "com.ericsson.bss.rm.erms.core.entity.dto.pm.ExchangeRateDTO"
  }</con:request><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="bb4bdf78-c71f-47b4-901d-98a4d88d67df" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateToCurrencyMainCurrency" id="ea9efe79-a5ce-4a9b-8ed4-99f2ab01b1a3"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromEURToTL" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#toCurrencyId}",
    "toCurrency": "${#TestSuite#mainCurrencyId}",
    "rate": 4.15,
    "fromDate": "2016-12-23T07:26:28+0000",
    "toDate": "2018-12-25T07:26:28+0000",
    "type": "com.ericsson.bss.rm.erms.core.entity.dto.pm.ExchangeRateDTO"
  }</con:request><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="36550065-2854-470d-a285-5721c171d69e" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateMainCurrencyFromCurrency" id="e42cbda6-5df8-4122-92fa-fe8fb84f8fb5"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromTLToEUR" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#mainCurrencyId}",
    "toCurrency": "${#TestSuite#fromCurrencyId}",
    "rate": 0.24,
    "fromDate": "2016-12-23T07:26:28+0000",
    "toDate": "2018-12-25T07:26:28+0000",
    "type": "com.ericsson.bss.rm.erms.core.entity.dto.pm.ExchangeRateDTO"
  }</con:request><con:originalUri>http://localhost/erms/v1/exchangeRate</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="46c1c6d0-91a7-4929-bce6-028569a8a603" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="addExchangeRateMainCurrencyToCurrency" id="168b0010-7d04-4f06-8528-f1c37e46ee22"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/exchangeRate?" methodName="addExchangeRate" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addExchangeRateFromTLToUSD" id="33facbda-ea64-4381-a982-4fbaa57a3252" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromCurrency": "${#TestSuite#mainCurrencyId}",
    "toCurrency": "${#TestSuite#toCurrencyId}",
    "rate": 0.34,
    "fromDate": "2016-12-23T07:26:28+0000",
...
def getJson(String response){
  ...
  "amount": {
    ...
    "currency": "${#TestSuite#mainCurrencyId}"
  }
...
def getJson(String response){
  ...
  "salesOrganizationRoleId": "${#TestSuite#SalesOrganization}",
  "businessInteractionSpec": {
    "code": "MONETARY_TRANSACTION_BISPEC"
  }
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="fc4da866-5c60-44bf-b1f3-6eff5d0e585e" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="b84c6531-82b7-4c11-822a-f3d632dae73b" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item for NonExistingBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Add Money Transfer Interaction" id="d9d63c3c-0153-4380-9cd1-0db8fd3c6d20"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Add Money Transfer Interaction" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":${#TestSuite#fromAccountId},
    "toAccountId":${#TestSuite#toAccountId},
    "amount":{
        "notRoundedAmount":${#TestSuite#amount},
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="0000" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="39a7d422-7a62-4740-b55f-d663ede1664e" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Submit Money Transfer With NonExistingBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Submit money transfer interaction" id="94b46949-c505-4469-8d73-48a4cb3ffa8e"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/submit" methodName="Submit money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Submit money transfer interaction" id="4a5bd29d-c0ac-4cff-826a-41a7b24fc2c6" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/197/submit</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="f8766b7b-3912-4b43-95f7-256e092893c9" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="0000" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="75936c8c-585a-433a-9513-0e3afdbe3bb8" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Create Money Interaction Success" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="createMoneyTransferInteraction" id="2ca199b0-1185-4801-98cc-22084520f6cc"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer" methodName="Create Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="createMoneyTransferInteraction" id="e5afa7ec-3709-4dc3-b507-60dec8fa35d8" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
  "userRoleId": "${#TestSuite#User}",
  "salesOrganizationRoleId": "${#TestSuite#SalesOrganization}",
  "businessInteractionSpec": {
    "code": "MONETARY_TRANSACTION_BISPEC"
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/91/item</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="4b303283-f5c1-4dca-9964-77774d246e02" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="98442935-3662-428a-83e6-84277c6527ec" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item With Amount Character" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="addMoneyInteractionItem" id="17fb15e8-40b9-4f52-b8e5-0d40f0dc907d"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addMoneyInteractionItem" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":"${#TestSuite#fromAccountId}",
    "toAccountId":"${#TestSuite#toAccountId}",
    "amount":{
        "notRoundedAmount":"adas",
        "currency":"${#TestSuite#mainCurrencyId}",
        "roundedAmount": 15
    }
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/91/item</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="4b303283-f5c1-4dca-9964-77774d246e02" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="51673d09-2eea-4964-94ab-a1c8bd51b441" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item Cancel" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="createMoneyTransferInteraction" id="131d6d76-92cb-4243-a186-02f48da426e2"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer" methodName="Create Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="createMoneyTransferInteraction" id="e5afa7ec-3709-4dc3-b507-60dec8fa35d8" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
  "userRoleId": "${#TestSuite#User}",
  "salesOrganizationRoleId": "${#TestSuite#SalesOrganization}",
  "businessInteractionSpec": {
    "code": "MONETARY_TRANSACTION_BISPEC"
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="displayFromAccountBeforeMoneyTransfer" id="b3e95c97-8247-40cd-a0dc-d82950a62daa"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/account/{accountId}" methodName="displayAccount" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayFromAccountBeforeMoneyTransfer" id="372d87fe-611d-4760-84aa-fee0d951a315" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/account/73</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="ad16f6d6-4c48-4f6c-8c98-56455ec35261" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="accountId" value="${#TestSuite#fromAccountId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>accountId</con:entry><con:entry>account</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setFromAccountAmountBeforeMoneyTransfer" id="a35482d6-2c36-40a8-89a9-72b10b17f54e"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="displayToAccountBeforeMoneyTransfer" id="aa2f9c6a-4cb3-4533-9029-53e64a469bee"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/account/{accountId}" methodName="displayAccount" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayToAccountBeforeMoneyTransfer" id="372d87fe-611d-4760-84aa-fee0d951a315" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/account/74</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="bfec8bdd-115c-428f-a83d-ecf8175fa268" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="accountId" value="${#TestSuite#toAccountId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>accountId</con:entry><con:entry>account</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setToAccountAmountBeforeMoneyTransfer" id="d71c0d43-b29f-4985-b47b-232d9a31a3fe"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="Cancel money transfer interaction" id="7cf08dc7-640d-4b7e-9aa5-8af4a3531118"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/cancel" methodName="Cancel money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Cancel money transfer interaction" id="5b56fac3-1335-4241-bad5-878a54a84a36" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/711/cancel</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="a06a8a46-00ce-4b3c-8803-7ed6f20aa086" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="submitMoneyTransferInteraction" id="ae5100b0-55da-4487-aaec-5a9faf8535a6"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/submit" methodName="Submit money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="submitMoneyTransferInteraction" id="4a5bd29d-c0ac-4cff-826a-41a7b24fc2c6" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/197/submit</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="f8766b7b-3912-4b43-95f7-256e092893c9" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="displayFromAccountAfterMoneyTransfer" id="a9e78161-88b7-46b3-b53d-62819ba5f1c6"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/account/{accountId}" methodName="displayAccount" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayFromAccountAfterMoneyTransfer" id="372d87fe-611d-4760-84aa-fee0d951a315" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/account/73</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="ad16f6d6-4c48-4f6c-8c98-56455ec35261" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="accountId" value="${#TestSuite#fromAccountId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>accountId</con:entry><con:entry>account</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setFromAccountAmountAfterMoneyTransfer" id="63c4f605-27a9-4a18-9203-ccef83b47ee9"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="displayToAccountAfterMoneyTransfer" id="5b588ed3-2582-40ba-97e8-c27a65eeffe8"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/account/{accountId}" methodName="displayAccount" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayToAccountAfterMoneyTransfer" id="372d87fe-611d-4760-84aa-fee0d951a315" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/account/74</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="bfec8bdd-115c-428f-a83d-ecf8175fa268" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="accountId" value="${#TestSuite#toAccountId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>accountId</con:entry><con:entry>account</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setToAccountAmountAfterMoneyTransfer" id="7a3899a9-a4bf-4244-960c-cfb528220c77"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
</script></con:config></con:testStep><con:testStep type="groovy" name="checkAccountBalances" id="534496e9-c2ae-422b-ae72-aca8df77b3d5"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
void checkAccountBalances(){
	...
	assert fromAccountAmountAfterTransfer == fromAccountAmountBeforeTransfer;
	assert toAccountAmountAfterTransfer == toAccountAmountBeforeTransfer;
...
</script></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="f7a5fd40-b23f-4354-a2bc-e8ba14faab99" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item With NonExistingCurrency" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="createMoneyTransferInteraction" id="a6b1f14b-b34e-431a-95ca-6b076904dd1a"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer" methodName="Create Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="createMoneyTransferInteraction" id="e5afa7ec-3709-4dc3-b507-60dec8fa35d8" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
  "userRoleId": "${#TestSuite#User}",
  "salesOrganizationRoleId": "${#TestSuite#SalesOrganization}",
  "businessInteractionSpec": {
    "code": "MONETARY_TRANSACTION_BISPEC"
  }
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="dfbe81bb-c336-40e9-a50f-5aa18f503a1f" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setBiId" id="71cdef4c-7334-4eb9-85df-1b7d7a2e887e"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
def getJson(String response){
	...
	return json
}</script></con:config></con:testStep><con:testStep type="restrequest" name="addMoneyInteractionItem" id="836b6426-ad34-4fa1-830a-1e27d34c8083"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addMoneyInteractionItem" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":"${#TestSuite#fromAccountId}",
    "toAccountId":"${#TestSuite#toAccountId}",
    "amount":{
        "notRoundedAmount":"${#TestSuite#amount}",
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setItemIdFirst" id="9186291d-ca69-415e-8f30-52323a283bff"><con:settings/><con:config><script>import net.sf.json.groovy.*;

setItemIdFirst()

void setItemIdFirst(){
	def testStep = testRunner.testCase.getTestStepByName("addMoneyTransferInteractionFirst");
	def jsonItem = getJson(testStep.getPropertyValue("Response").toString())
	assert jsonItem.id != null
	testRunner.testCase.testSuite.setPropertyValue("itemIdFirst", jsonItem.id.toString())
}
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="addMoneyTransferInteractionSecond" id="8800761a-9c8b-4cef-96e7-dfcf80d238ce"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="addMoneyTransferInteractionSecond" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":${#TestSuite#fromAccountId},
    "toAccountId":${#TestSuite#toAccountId},
    "amount":{
        "notRoundedAmount":${#TestSuite#amount},
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setItemIdSecond" id="ac528a78-fd5c-42dd-ac11-f63776a57336"><con:settings/><con:config><script>import net.sf.json.groovy.*;

setItemIdSecond()

void setItemIdSecond(){
	def testStep = testRunner.testCase.getTestStepByName("addMoneyTransferInteractionSecond");
	def jsonItem = getJson(testStep.getPropertyValue("Response").toString())
	assert jsonItem.id != null
	testRunner.testCase.testSuite.setPropertyValue("itemIdSecond", jsonItem.id.toString())
}
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="displayMoneyTransferInteractionItems" id="7b7d4653-d55e-41cc-bea0-fdd5e8ea4993"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/item" methodName="Display money transfer interaction items" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayMoneyTransferInteractionItems" id="a51f51a0-15f3-465e-8609-733aebb98f9f" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/1281/item</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="f383b7ad-4fbb-4251-bacb-13390b661d08" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="checkAddMoneyTransferItems" id="01f81724-55d5-478a-9305-4590a0fd987b"><con:settings/><con:config><script>import net.sf.json.groovy.*;

checkBIDescription()

void checkBIDescription(){
	def itemIdFirst = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("itemIdFirst"));
	def itemIdSecond = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("itemIdSecond"));
	def mainStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("mainStateClosed"));
	def sessionStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("sessionStateClosed"));
	def testStep = testRunner.testCase.getTestStepByName("displayMoneyTransferInteractionItems");
	def jsonArray = getJson(testStep.getPropertyValue("Response").toString())

	Boolean itemFirstFound = false;
	Boolean itemSecondFound = false;
	for(jsonItem in jsonArray)
	{
		if(jsonItem.id == itemIdFirst){
			itemFirstFound = true;
		}
		if(jsonItem.id == itemIdSecond){
			itemSecondFound = true;
		}
	}

	if((itemFirstFound == true) &amp;&amp; (itemSecondFound == true)){
		assert (true);		
	}else {
		assert (false);
	}
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="displaySingleMoneyTransaction" id="c85dff70-c032-4e99-868d-af51fb7f1052"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}" methodName="Display a single money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displaySingleMoneyTransaction" id="4ead2770-26fc-43c7-b23f-fa56c08c05e1" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/1191</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="93bf4e3a-0ffa-4f8a-86f1-6e6517b7c38d" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="checkBIDescription" id="0b7bd7bd-dafd-4730-bf3a-6373262017e5"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
void checkBIDescription(){
	def mainStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("mainStateClosed"));
	def sessionStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("sessionStateClosed"));
	def testStep = testRunner.testCase.getTestStepByName("displaySingleMoneyTransaction");
	def jsonItem = getJson(testStep.getPropertyValue("Response").toString())
	assert jsonItem.mainState == mainStateClosed
	assert jsonItem.state == sessionStateClosed
}
...
</script></con:config></con:testStep><con:testStep type="restrequest" name="displayAllMoneyTransactions" id="72d94aec-c250-464e-a03a-675deaeba858"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer" methodName="Display money transfer interactions" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="displayAllMoneyTransactions" id="8a122cf4-0896-484c-b304-d3e055701cf8" mediaType="application/json"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="fd3bfaf6-1443-4b43-8b45-b06fec23dfa6" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="checkBIDescriptionFromAll" id="0a837e3b-549d-4df2-aa44-bf543543a6d0"><con:settings/><con:config><script>import net.sf.json.groovy.*;

checkBIDescription()

void checkBIDescription(){
	def biId = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("biId"));
	def mainStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("mainStateClosed"));
	def sessionStateClosed = Integer.parseInt(testRunner.testCase.testSuite.getPropertyValue("sessionStateClosed"));
	def testStep = testRunner.testCase.getTestStepByName("displayAllMoneyTransactions");
	def jsonArray = getJson(testStep.getPropertyValue("Response").toString())
...
void checkAccountBalances(){
  ...
  "amount": {
    "notRoundedAmount": ${#TestSuite#balance},
    "currency": "${#TestSuite#fromCurrencyId}"
  }
  ...
  "amount": {
    "notRoundedAmount": ${#TestSuite#balance},
    "currency": ${#TestSuite#toCurrencyId}
  }
...
def getExchangeRate(String fromCurrencyId, String toCurrencyId){
	def testStep = testRunner.testCase.getTestStepByName("listExchangeRates");
	def json = getJson(testStep.getPropertyValue("Response").toString())
...
</script></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="572db3fd-46c1-414d-a41b-b36d6b47a15a" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item to ClosedBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Add Money Transfer Interaction" id="ff69477d-07cf-4940-abc3-f1317e0e35e7"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Add Money Transfer Interaction" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":${#TestSuite#fromAccountId},
    "toAccountId":${#TestSuite#toAccountId},
    "amount":{
        "notRoundedAmount":${#TestSuite#amount},
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:testStep type="restrequest" name="Submit money transfer interaction" id="d8f6a5cc-f3a6-46ed-b790-a5710a4a9f13"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/submit" methodName="Submit money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Submit money transfer interaction" id="4a5bd29d-c0ac-4cff-826a-41a7b24fc2c6" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/197/submit</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="f8766b7b-3912-4b43-95f7-256e092893c9" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="a1dcbcb8-ac0c-4143-b610-0e43d7199555" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Cancel NonExistingBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Cancel money transfer interaction" id="1837a97c-b20e-441c-be2a-d1c47bc8a0a9"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/cancel" methodName="Cancel money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Cancel money transfer interaction" id="5b56fac3-1335-4241-bad5-878a54a84a36" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/711/cancel</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="a06a8a46-00ce-4b3c-8803-7ed6f20aa086" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="0000" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="28597077-c075-40b0-b64e-b86be3615898" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item Cancel ClosedBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Cancel money transfer interaction" id="d658957b-8bb2-4f68-8c52-c2571ed04a83"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/cancel" methodName="Cancel money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Cancel money transfer interaction" id="5b56fac3-1335-4241-bad5-878a54a84a36" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/711/cancel</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="a06a8a46-00ce-4b3c-8803-7ed6f20aa086" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="4140ece1-1c69-49af-a15f-ee37eb6ec9da" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Cancel CreateBI Interaction" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="createMoneyTransferInteraction" id="1035919c-9e52-4465-82c4-4cd6e550d853"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer" methodName="Create Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="createMoneyTransferInteraction" id="e5afa7ec-3709-4dc3-b507-60dec8fa35d8" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
  "userRoleId": "${#TestSuite#User}",
  "salesOrganizationRoleId": "${#TestSuite#SalesOrganization}",
  "businessInteractionSpec": {
    "code": "MONETARY_TRANSACTION_BISPEC"
  }
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="dfbe81bb-c336-40e9-a50f-5aa18f503a1f" name="Valid HTTP Status Codes"><con:configuration><codes>201</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters/></con:restRequest></con:config></con:testStep><con:testStep type="groovy" name="setBiId" id="06553dca-0402-4fd2-b2c9-ca2ac0b2a87b"><con:settings/><con:config><script>import net.sf.json.groovy.*;
...
def getJson(String response){
	...
	return json
}</script></con:config></con:testStep><con:testStep type="restrequest" name="Cancel money transfer interaction" id="94c72fd2-1f88-4f10-bdeb-a64aec04a1fc"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{id}/cancel" methodName="Cancel money transfer interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Cancel money transfer interaction" id="5b56fac3-1335-4241-bad5-878a54a84a36" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request/><con:originalUri>http://localhost/erms/v1/moneyTransfer/711/cancel</con:originalUri><con:assertion type="Valid HTTP Status Codes" id="a06a8a46-00ce-4b3c-8803-7ed6f20aa086" name="Valid HTTP Status Codes"><con:configuration><codes>200</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="id" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:testCase id="a4f1ff5e-8c07-4779-b803-03efc20bd32d" failOnError="true" failTestCaseOnErrors="true" keepSession="false" maxResults="0" name="Atomic Add Money Item for CancelledBI" searchProperties="true"><con:settings/><con:testStep type="restrequest" name="Add Money Transfer Interaction" id="3eeac318-980f-4118-948f-28fa6f1ee02b"><con:settings/><con:config service="Resources" resourcePath="/${#Project#Prefix}/moneyTransfer/{biId}/item" methodName="Add Money Transfer Interaction" xsi:type="con:RestRequestStep" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:restRequest name="Add Money Transfer Interaction" id="2f4d9525-7ce9-4b0f-9f95-dc519ec25eae" mediaType="application/json" postQueryString="false"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:endpoint>http://${#Project#ERMS_connect}</con:endpoint><con:request>{
    "fromAccountId":${#TestSuite#fromAccountId},
    "toAccountId":${#TestSuite#toAccountId},
    "amount":{
        "notRoundedAmount":${#TestSuite#amount},
...
}</con:request><con:originalUri>http://localhost/erms/v1/moneyTransfer/165/item</con:originalUri><con:assertion type="GroovyScriptAssertion" id="a14df892-6511-43dc-bbec-dea8eb38b29c" name="Script Assertion"><con:configuration/></con:assertion><con:assertion type="Valid HTTP Status Codes" id="bfa9d4d1-6ebe-44f4-a8ec-8706c8b5a96a" name="Valid HTTP Status Codes"><con:configuration><codes>400</codes></con:configuration></con:assertion><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:parameters><entry key="biId" value="${#TestSuite#biId}" xmlns="http://eviware.com/soapui/config"/></con:parameters><con:parameterOrder><con:entry>biId</con:entry></con:parameterOrder></con:restRequest></con:config></con:testStep><con:properties/></con:testCase><con:properties><con:property><con:name>User</con:name><con:value>5</con:value></con:property><con:property><con:name>SalesOrganization</con:name><con:value>3</con:value></con:property><con:property><con:name>biId</con:name><con:value>14</con:value></con:property><con:property><con:name>entityId</con:name><con:value>4018</con:value></con:property><con:property><con:name>fromAccountId</con:name><con:value>1</con:value></con:property><con:property><con:name>toAccountId</con:name><con:value>2</con:value></con:property><con:property><con:name>amount</con:name><con:value>100.05</con:value></con:property><con:property><con:name>secondUserId</con:name><con:value>8</con:value></con:property><con:property><con:name>secondSoId</con:name><con:value>6</con:value></con:property><con:property><con:name>balance</con:name><con:value>1000.01</con:value></con:property><con:property><con:name>fromCurrencyId</con:name><con:value>USD</con:value></con:property><con:property><con:name>toCurrencyId</con:name><con:value>TRY</con:value></con:property><con:property><con:name>mainCurrencyId</con:name><con:value>EUR</con:value></con:property><con:property><con:name>fromAccountAmountAfterTransfer</con:name><con:value>4249.85</con:value></con:property><con:property><con:name>toAccountAmountAfterTransfer</con:name><con:value>5550.25</con:value></con:property><con:property><con:name>fromAccountAmountBeforeTransfer</con:name><con:value>4349.9</con:value></con:property><con:property><con:name>toAccountAmountBeforeTransfer</con:name><con:value>5450.2</con:value></con:property><con:property><con:name>mainStateClosed</con:name><con:value>0</con:value></con:property><con:property><con:name>sessionStateClosed</con:name><con:value>5</con:value></con:property><con:property><con:name>itemIdFirst</con:name><con:value>5</con:value></con:property><con:property><con:name>itemIdSecond</con:name><con:value>6</con:value></con:property></con:properties></con:testSuite><con:properties><con:property><con:name>ERMS_connect</con:name><con:value>${#Project#Path}</con:value></con:property><con:property><con:name>Path</con:name><con:value>localhost:8181</con:value></con:property><con:property><con:name>Prefix</con:name><con:value>erms/v1</con:value></con:property><con:property><con:name>entityId</con:name><con:value>1000</con:value></con:property><con:property><con:name>runnable</con:name><con:value>true</con:value></con:property></con:properties><con:wssContainer/><con:oAuth2ProfileContainer/><con:oAuth1ProfileContainer/><con:sensitiveInformation/></con:soapui-project>